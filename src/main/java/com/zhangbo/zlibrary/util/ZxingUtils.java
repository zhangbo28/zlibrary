...
public class ZxingUtils {
    ...
    public static Bitmap createQRImage(String content,int size,Bitmap logoBitmap){
        Bitmap srcBitmap = createQRImage(content,size);
        if(srcBitmap!=null){
           return addLogo(srcBitmap,logoBitmap,0.2f);
        }
    ...
    public static Bitmap createWithLogo(String content,int size,Bitmap logoBitmap){
        return createQRCodeBitmap(content, size, size,"UTF-8","H", "1", Color.BLACK, Color.WHITE,logoBitmap,0.2F);
    }
