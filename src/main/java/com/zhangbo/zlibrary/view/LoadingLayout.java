...
/**
 * 处理页面加载时的4种状态处理（加载中、加载成功、加载失败、加载为空）
 */
public class LoadingLayout extends FrameLayout implements ILoadingView{
    ...
    int mEmptyImage=NO_ID;
    CharSequence mEmptyText;

    int mErrorImage=NO_ID;
